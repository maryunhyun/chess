...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_CREME_YELLOW = SET_TEXT_COLOR + "222m";
    public static final String SET_TEXT_COLOR_CREME_BROWN = SET_TEXT_COLOR + "95m";
    public static final String SET_TEXT_COLOR_BLUE = SET_TEXT_COLOR + "12m";
    public static final String SET_TEXT_COLOR_MAGENTA = SET_TEXT_COLOR + "5m";
    public static final String SET_TEXT_COLOR_WHITE = SET_TEXT_COLOR + "15m";
    public static final String SET_TEXT_COLOR_MATCH_SCREEN = SET_TEXT_COLOR + "235.5m";
    ...
    public static final String SET_BG_COLOR_MATCH_SCREEN = SET_BG_COLOR + "235.5m";
    ...
    public static final String SET_BG_COLOR_CREME_YELLOW = SET_BG_COLOR + "222m";
    public static final String SET_BG_COLOR_CREME_BROWN = SET_BG_COLOR + "95m";
