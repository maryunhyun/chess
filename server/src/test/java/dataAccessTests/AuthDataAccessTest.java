...
public class AuthDataAccessTest {
    ...
    @Test
    public void addAuthDataPass() throws DataAccessException, ResponseException {
        try {
    ...
    @Test
    public void addAuthDataFail() throws DataAccessException, ResponseException {
    ...
    @Test
    public void listAuthDatasPass() throws DataAccessException, ResponseException {
    ...
    @Test
    public void listAuthDatasFail() throws DataAccessException, ResponseException {
        authDAO.addAuthData(authData1);
        assertEquals(true,authDAO.listAuthDatas().contains(authData1));
        authDAO.addAuthData(authData2);
        clearService.clearAll();
    ...
    @Test
    public void getAuthDataPass() throws DataAccessException, ResponseException {
        clearService.clearAll();
        authDAO.addAuthData(authData1);
    ...
    @Test
    public void getAuthDataFail() throws DataAccessException, ResponseException {
        clearService.clearAll();
        authDAO.addAuthData(authData1);
    ...
    @Test
    public void deleteAuthDataPass() throws DataAccessException, ResponseException {
        clearService.clearAll();
        authDAO.addAuthData(authData1);
        authDAO.addAuthData(authData2);
    ...
    @Test
    public void deleteAuthDataFail() throws DataAccessException, ResponseException {
        clearService.clearAll();
        authDAO.addAuthData(authData1);
        authDAO.addAuthData(authData2);
    ...
    @Test
    public void clearAuthDatasPass() throws DataAccessException, ResponseException {
        authDAO.addAuthData(authData1);
        authDAO.addAuthData(authData2);
        clearService.clearAll();
