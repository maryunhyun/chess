...
public class AuthDataAccessTest {
    ...
    @Test
    public void addAuthDataPass() throws DataAccessException{
    ...
    @Test
    public void addAuthDataFail() throws DataAccessException{
    ...
    @Test
    public void listAuthDatasPass() throws DataAccessException{
        clearService.clearAll();
    ...
    @Test
    public void listAuthDatasFail() throws DataAccessException{
    ...
    @Test
    public void deleteAuthDataPass() throws DataAccessException{
        clearService.clearAll();
    ...
    @Test
    public void clearAuthDatasPass() throws DataAccessException{
        clearService.clearAll();
