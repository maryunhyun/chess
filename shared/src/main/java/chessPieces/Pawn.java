...
public class Pawn {
    ...
    HashSet<ChessMove> firstMoveBlack(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
        ...
        i = i - 1;
        if (j < 9 && j > 0 && i < 9 && i > 0) {
            normalMove(i,j,z,board,myPosition,chessPositions7,chessMoves7,movesCollection);
            //checking for enemies in diagonal
            j--;
            if (j > 0) {
                diagonalMove(i, j, z, board, myPosition, chessPositions7, chessMoves7, movesCollection);
    ...
    HashSet<ChessMove> normalMoveBlack(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
        ...
        if (j < 9 && j > 0 && i < 9 && i > 0) {
            ...
            //checking for enemies in diagonal
            j--;
            diagonalCheck(i,j,z,board,myPosition,chessPositions7,chessMoves7,movesCollection);
            j = j + 2;
            diagonalCheck(i,j,z,board,myPosition,chessPositions7,chessMoves7,movesCollection);
            i = myPosition.getRow();
            j = myPosition.getColumn();
    ...
    HashSet<ChessMove> normalMoveWhite(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
        ...
        if (j < 9 && j > 0 && i < 9 && i > 0) {
            if (board.getBoardSquares()[i - 1][j - 1] == null) {
                promotionEndofBoardWhite(i,j,z,board,myPosition,chessPositions7,chessMoves7,movesCollection);
            }
            //checking for enemies in diagonal
            j++;
            if (j < 9) {
    ...
    HashSet<ChessMove> promotionEndofBoardWhite(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
    ...
    HashSet<ChessMove> promotionEndofBoardBlack(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
        //promotion if reach end of board
        if (i == 1) {
            promotion(i, j, z, board, myPosition, chessPositions7, chessMoves7, movesCollection);
        } else {
    ...
    HashSet<ChessMove> diagonalCheck(int i, int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions7, ChessMove[] chessMoves7, HashSet<ChessMove> movesCollection) {
        if (board.getBoardSquares()[i - 1][j - 1] != null) {
            if (board.getBoardSquares()[i - 1][j - 1].getTeamColor() != board.getBoardSquares()[myPosition.getRow() - 1][myPosition.getColumn() - 1].getTeamColor()) {
                promotionEndofBoardBlack(i,j,z,board,myPosition,chessPositions7,chessMoves7,movesCollection);
            }
