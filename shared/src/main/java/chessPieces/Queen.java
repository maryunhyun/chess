...
public class Queen {
    public HashSet<ChessMove> queenMoves(ChessBoard board, ChessPosition myPosition, HashSet<ChessMove> movesCollection) {
        //moving like ROOK & increasing row
        int j = myPosition.getColumn();
        ChessPosition [] chessPositions12 = new ChessPosition[10];
        ChessMove [] chessMoves12 = new ChessMove[10];
        int z = 0;
        moveLikeRook(j,z,board,myPosition,chessPositions12,chessMoves12,movesCollection);
        //moving like BISHOP & increasing row and column
    ...
    HashSet<ChessMove> moveLikeRook( int j, int z, ChessBoard board, ChessPosition myPosition, ChessPosition[] chessPositions12, ChessMove[] chessMoves12, HashSet<ChessMove> movesCollection) {
        for (int i = myPosition.getRow()+1; i < 9; i++ ) {
